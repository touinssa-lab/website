...
def sync_data():
    ...
    insights = [
        {
            "keyword": "신안 퍼플섬 라벤더 축제",
            "category": "미디어/콘텐츠",
            "reason": "[팩트체크] 신안 퍼플섬이 5월 라벤더 개화 시기를 맞아 '퍼플 섬'이라는 강력한 지역 브랜딩을 바탕으로 실시간 트렌드 상위권에 올랐습니다. 보라색 테마와 연계된 지역 특화 콘텐츠가 관광객들에게 명확한 방문 동기를 제공하며 인스타그램 등 미디어 콘텐츠로의 확산성이 높게 나타나고 있습니다. [산업영향] 지자체의 명확한 컬러 마케팅과 계절 콘텐츠의 결합이 실질적인 관광객 유입과 지역 이미지 제고로 이어지는 선순환 구조를 보여주고 있습니다.",
            "type": "analysis",
            "target_date": target_date
        },
        {
            "keyword": "대학 축제 및 로컬 콘텐츠",
            "category": "사회/인구",
            "reason": "[팩트체크] 5월 대학 축제 시즌을 맞아 한양대, 경희대 등 주요 대학의 라인업과 입장권 정보가 핵심 키워드로 부상했습니다. 대학 축제가 단순한 학내 행사를 넘어 지역의 주요 관광 및 문화 콘텐츠로 자리매김하고 있습니다. [산업영향] 젊은 층의 대규모 이동을 유발하는 대학 축제는 주변 상권의 소비 활성화는 물론, '로컬 페스티벌'로서의 관광 상품화 가능성을 시사하고 있습니다.",
            "type": "analysis",
            "target_date": target_date
        },
        {
            "keyword": "항공업계 통합 기대감",
            "category": "정책/행정",
            "reason": "[팩트체크] 대한항공과 아시아나항공의 합병 절차가 막바지에 다다르며 마일리지 전환 및 통합 항공사 출범에 대한 검색량이 폭증했습니다. [산업영향] 항공업계의 거대 구조 개편은 향후 인바운드 및 아웃바운드 관광 시장의 노선 경쟁력과 가격 체계에 지대한 영향을 미칠 것이며, 이는 여행사들의 상품 구성 변화로 이어질 전망입니다.",
            "type": "analysis",
            "target_date": target_date
        },
        {
            "keyword": "로컬 미식 여행의 세분화",
            "category": "유통/식음료",
            "reason": "[팩트체크] '잠실역', '삼성동', '을지로' 등 특정 거점 중심의 맛집 검색이 강화되며 도시 내 미식 투어가 더욱 정교하게 세분화되고 있습니다. [산업영향] 여행객들이 지역만의 독특한 미식 경험을 중요시함에 따라, 단순 명소 방문을 넘어 특정 상권의 '찐 맛집'을 찾아다니는 목적형 관광이 주류로 자리 잡고 있습니다.",
            "type": "unique",
            "target_date": target_date
        },
        {
            "keyword": "민둥산 정산 등반 수요",
            "category": "환경/기후",
            "reason": "[팩트체크] 봄철 야외 활동 인구가 늘어남에 따라 억새꽃으로 유명한 정선 민둥산이 급상승 검색어 1위를 기록했습니다. [산업영향] 계절적 요인과 연계된 자연 경관 중심의 관광 수요는 지역의 등산 및 나들이 관련 인프라에 대한 높은 관심을 반영하며, 웰니스 및 액티비티 관광 시장의 확대를 보여줍니다.",
            "type": "unique",
            "target_date": target_date
        }
    ]
    ...
    tourism_articles = [
        {
            ...
            "press": "연합뉴스",
            "excerpt": "신한은행이 한국관광공사 및 충청권 지자체들과 협력하여 일본인 관광객 유치를 위한 마케팅을 대폭 강화합니다. 일본 현지법인 SBJ은행의 네트워크를 활용해 지역 특화 관광 상품을 홍보하고 결제 편의성을 높이는 등 실질적인 인바운드 활성화를 추진합니다. 금융과 관광의 결합 모델은 지역 경제 활성화의 새로운 대안으로 주목받고 있습니다.",
            "tag": "여행/관광",
        ...
        },
        {
            ...
            "press": "연합뉴스",
            "excerpt": "카지노와 호텔 부문의 동반 성장에 힘입어 1분기 매출 1562억원을 기록하며 사상 최대 분기 실적을 달성했습니다. 이는 외국인 관광객 증가와 보복 소비 심리가 맞물린 결과로 분석되며, 관광 대장주로서의 입지를 공고히 하고 있습니다.",
            "tag": "기업/금융",
        ...
        },
        {
            ...
            "press": "한국경제",
            "excerpt": "중국인 단체 관광객들의 제주 방문이 급증하면서 관련 업계가 유례없는 호황을 맞고 있습니다. 엔저 현상에도 불구하고 무비자 입국이 가능한 제주의 매력이 부각되며 중국인 관광객들의 소비 규모도 대폭 늘어난 것으로 나타났습니다. 관광 수지가 11년 만에 흑자로 전환되는 등 제주 관광 시장의 체질 개선이 가속화되고 있습니다.",
            "tag": "여행/관광",
        ...
        },
        {
            ...
            "press": "스포츠서울",
            "excerpt": "영랑호 벚꽃축제 기간 동안 4만 8천 명의 방문객이 몰리며 지역 축제를 넘어 외지인에게도 매력적인 관광 콘텐츠로 자리매김했습니다. 지역 특화 콘텐츠의 중요성을 다시 한번 확인한 사례입니다.",
            "tag": "여행/관광",
        ...
        },
        {
            ...
            "press": "뉴시스",
            "excerpt": "G마켓과 인천관광공사가 협업하여 '온라인 인천상회' 기획전 등을 통해 인천 기반 관광 상품의 온라인 유통망을 대폭 강화합니다. 디지털 플랫폼을 활용한 관광 마케팅의 외연이 더욱 넓어질 전망입니다.",
            "tag": "여행/관광",
    ...
    ai_articles = [
        ...
        },
        {
            ...
            "press": "매일신문",
            "link": "https://n.news.naver.com/mnews/article/088/01009963?sid=102",
