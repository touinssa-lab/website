...
const REGIONS = [
  {
    ...
    latest:'2025.10 시화호 해양전략 국제포럼 개최 · 경기·화성·안산·시흥 공동협약 · 시화호 통합BI 선포 · 전기유람선 뱃길(반달섬~방아머리 13km) 취항 예정',
  ...
  },
  {
    ...
    extra_type:'travel', extra:{},
    latest:'해파랑길 45코스(17.6km) 아바이마을 경유 · 청량리↔강릉 KTX-이음 편도 26,000원 하루 17~24회 · 강릉역→강릉시외버스터미널 시내버스 30분 · 강릉→속초 시외버스 직통 1시간 / 완행 1시간20분(하루 21회)',
  ...
  },
  {
    ...
    extra_type:'travel', extra:{},
    latest:'2025 케이펫페어 반려동물 친화관광도시 태안 홍보 · SNS 펫니스태안 운영 · 안면도 관광지 조성 착공(2025) · 태안 해안순환도로 완전 개통 예정(2026.12) · 꽃지해수욕장·팜카밀레 반려동물 동반 가능',
  ...
  },
  {
    ...
    extra_type:'travel', extra:{},
    latest:'완도해양치유센터 누적 방문 13만명 · 2026 우수 웰니스 관광지 재지정 · 장기 체류형 1박2일~5박6일 프로그램 참가비 30~70% 지원(2026.3~) · 완도 치유 페이 200억 경제효과 · 힐링해 완도 프로젝트(102억) 착공 · 2026 지방소멸대응기금 120억 확보',
  ...
  },
  {
    ...
    extra_type:'travel', extra:{},
    latest:'거제 옥계마을 2025 전국 어촌마을 전진대회 어촌특화 최우수상 · 거제 산달도마을 어촌체험휴양마을 대상 5년 연속 · 거제 트레일&웰니스 로컬 런트립(2026.3) 4:1 경쟁률 · 울산 간절곶 간절루 신설 · 2026 새해 드론라이트쇼 1,500대',
  ...
  },
  {
    ...
    travel:{'자연·경관':45.2,'휴식·회복':35.1,'미식':28.3},
    extra_type:'travel', extra:{},
    latest:'2026 새해 간절곶 드론라이트쇼 1,500대+불꽃놀이+야간경관전시 \'비밀의 정원\' · 간절루 신설(해 모양 곡선 지붕) · 진하해수욕장·서생포왜성 연계 코스 인기 · 한반도 최초 일출 명소 브랜딩 강화',
  ...
  },
  {
    ...
    extra_type:'travel', extra:{},
    latest:'제주알씨 러닝크루 플로깅 정기 운영 · 그랜드조선제주 올레길 플로깅 이벤트 · 올레길 27코스 운영(2026.3 기준) · 민박 활용 공정여행 모델 지속 · ESG 실수요 2% 미만 → 마케팅 언어 \'느린 제주\'로 재정의 필요',
  ...
  },
  {
    ...
    travel:{'자연·경관':67.8,'휴식·회복':45.8,'미식':44.6,'로컬':22.5},
    extra_type:'travel', extra:{},
    latest:'KTO×비양도 해양관광 콘텐츠 협약(2025) 이후 입도객 28.8% 증가(23만명) · 올리브 섬 조성 프로젝트 2026.4 본격 착수 · 올리브잎 비누체험·플로깅·러닝대회 계획 · 주민 60명 대부분 어업 종사 · 올리브 미식축제·지역특산물 개발 추진',
                  ...
                  <div className="bg-slate-100 rounded-xl p-7 border border-slate-200/60 font-sans shadow-md">
                    {activeRegion.extra_type !== 'travel' && Object.keys(activeRegion.extra).length > 0 ? (
                      ...
                      <>
                        ...
                        <div className="text-[14.5px] text-slate-600 leading-relaxed font-bold">
                          {activeRegion.latest}
                        </div>
                      </>
                    )}
